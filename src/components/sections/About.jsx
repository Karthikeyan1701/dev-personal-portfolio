                ...
                <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300">
                  <div className="grid grid-cols-3 gap-6 text-center">
                    <div>
                      ...
                      <div className="text-xs text-white/60">API Response Time</div>
                    </div>

                    <div>
                      <div className="text-2xl font-bold text-primary mb-1">90%+</div>
                      <div className="text-xs text-white/60">Lighthouse Score</div>
                    </div>

                    <div>
                      <div className="text-2xl font-bold text-primary mb-1">40%</div>
                      <div className="text-xs text-white/60">Load Time Reduction</div>
                    </div>
                  </div>
                </div>
              </div>
