...
const Skills = () => {
  const skillCategories = {
    ...
    'Authorization & Authentication': [
      skills.find((s) => s.name === 'JWT Authentication'),
      skills.find((s) => s.name === 'Role-Based Access Control'),
      skills.find((s) => s.name === 'OAuth'),
      skills.find((s) => s.name === 'Session Management'),
      skills.find((s) => s.name === 'Password Hashing (bcrypt)'),
    ].filter(Boolean),
    ...
    'DevOps & Deployment': [
      ...
      skills.find((s) => s.name === 'CI/CD Pipelines'),
      skills.find((s) => s.name === 'Environment Configuration'),
    ].filter(Boolean),
    ...
    'Tools & Engineering Practices': [
      ...
      skills.find((s) => s.name === 'Debugging & DevTools'),
    ...
    'Actively Exploring': [
      ...
      skills.find((s) => s.name === 'GenAI LLM API Integration')
    ].filter(Boolean),
  };
